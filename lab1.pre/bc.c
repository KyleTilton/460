...
int main()
{
  ...
  p = mbr + 446; //partition is at byte offset 0x1BE (446)
  p2 = mbr + 446 + 16;  // each partition is 16 bytes for the first 4.
  p3 = mbr + 446 + 32;
  printf("p# Type   start_sector   nr_sector \n");
  printf("1   MTX   ");
  printf("%u     ", p->start_sector);
  printf("%u\n", p->nr_sectors);
  printf("2   MTX   ");
  printf("%u     ", p2->start_sector);
  printf("%u\n", p2->nr_sectors);
  printf("3   MTX   ");
  printf("%u     ", p3->start_sector);
  printf("%u\n", p3->nr_sectors);
  printf("4   MTX   ");
  p4 = mbr + 446 + 48;
  printf("%l\n", p4->start_sector);
